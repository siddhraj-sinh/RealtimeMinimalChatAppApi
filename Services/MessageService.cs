...
namespace MinimalChatAppApi.Services
{
    public class MessageService : IMessageService
    {
        ...
        public MessageService(IRepository<Message> messageRepository, UserManager<IdentityUser> userManager, IHttpContextAccessor httpContextAccessor)
        {
        ...
        public async Task<IActionResult> GetConversationHistoryAsync(string userId, DateTime? before, int count = 20, string sort = "asc")
